...
func (d *domainClient) EnableRequestInterception(ctx context.Context, args *EnableRequestInterceptionArgs) (err error) {
	if args != nil {
		err = rpcc.Invoke(ctx, "Network.enableRequestInterception", args, nil, d.conn)
	} else {
		err = rpcc.Invoke(ctx, "Network.enableRequestInterception", nil, nil, d.conn)
	}
	if err != nil {
		err = &internal.OpError{Domain: "Network", Op: "EnableRequestInterception", Err: err}
	}
	return
}
