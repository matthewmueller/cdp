...
type DispatchKeyEventArgs struct {
	...
	Timestamp             protocol.Timestamp `json:"timestamp,omitempty"`             // Time at which the event occurred. Measured in UTC time in seconds since January 1, 1970 (default: current time).
...
func (a *DispatchKeyEventArgs) SetTimestamp(timestamp protocol.Timestamp) *DispatchKeyEventArgs {
...
// SetTimestamp sets the Timestamp optional argument. Time at which the event occurred. Measured in UTC time in seconds since January 1, 1970 (default: current time).
func (a *DispatchMouseEventArgs) SetTimestamp(timestamp protocol.Timestamp) *DispatchMouseEventArgs {
	a.Timestamp = timestamp
	return a
}
...
// SetTimestamp sets the Timestamp optional argument. Time at which the event occurred. Measured in UTC time in seconds since January 1, 1970 (default: current time).
func (a *DispatchTouchEventArgs) SetTimestamp(timestamp protocol.Timestamp) *DispatchTouchEventArgs {
	a.Timestamp = timestamp
	return a
}
...
type EmulateTouchFromMouseEventArgs struct {
	...
	Timestamp  protocol.Timestamp `json:"timestamp"`            // Time at which the event occurred. Measured in UTC time in seconds since January 1, 1970.
...
func NewEmulateTouchFromMouseEventArgs(typ string, x int, y int, timestamp protocol.Timestamp, button string) *EmulateTouchFromMouseEventArgs {
